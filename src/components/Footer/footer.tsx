      ...
      <S.FooterWrapper>
        <S.ColumnOne>
          <Link href="https://lacreisaude.com.br/">
            <S.LogoImg src="https://lacreisaude.com.br/_next/static/media/global-logo.e41aea7b.svg" alt="Logotipo da Lacrei" width={170} height={48} />
          </Link>
          <S.Nav>
            <Link href="https://www.facebook.com/lacrei.saude/" target="_blank">
              <S.Icon src="https://paciente.lacreisaude.com.br/_next/static/media/facebook.c4e93695.svg" alt="Facebook da Lacrei" width={32} height={32}/>
            </Link>
            <Link href="https://www.instagram.com/lacrei.saude/#" target="_blank">
              <S.Icon src="https://paciente.lacreisaude.com.br/_next/static/media/instagram.6b226165.svg" alt="Instagram da Lacrei" width={32} height={32}/>
            </Link>
            <Link href="https://www.linkedin.com/company/lacrei-saude/posts/?feedView=all" target="_blank">
              <S.Icon src="https://paciente.lacreisaude.com.br/_next/static/media/linkedin.a30519e7.svg" alt="Linkedin da Lacrei" width={32} height={32}/>
            </Link>
            <Link href="mailto:contato@lacreisaude.com.br" target="_blank">
              <S.Icon src="https://paciente.lacreisaude.com.br/_next/static/media/email-icon.6bcf7591.svg" alt="Email da Lacrei" width={32} height={32}/>
            </Link>
          </S.Nav>
        </S.ColumnOne>
        <S.ColumnTwo>
